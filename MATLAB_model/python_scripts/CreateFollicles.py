...
def create_follicles(parafoll, paraPoi, tb, te):
    ...
    data = pd.read_csv('StartTimesPoiss.txt', delim_whitespace=True, skiprows=1)
    data2 = pd.read_csv('FSH.txt', delim_whitespace=True, skiprows=1)
